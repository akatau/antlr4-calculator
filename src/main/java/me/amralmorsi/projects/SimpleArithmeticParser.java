...
public class SimpleArithmeticParser extends Parser {
	...
	public static class OperandContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleArithmeticVisitor ) return ((SimpleArithmeticVisitor<? extends T>)visitor).visitOperand(this);
	...
	public static class ParanthesisExpressionContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleArithmeticVisitor ) return ((SimpleArithmeticVisitor<? extends T>)visitor).visitParanthesisExpression(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ExponentiationOpContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleArithmeticVisitor ) return ((SimpleArithmeticVisitor<? extends T>)visitor).visitExponentiationOp(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class SubtractionOpContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleArithmeticVisitor ) return ((SimpleArithmeticVisitor<? extends T>)visitor).visitSubtractionOp(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class MultiplicationOpContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleArithmeticVisitor ) return ((SimpleArithmeticVisitor<? extends T>)visitor).visitMultiplicationOp(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class DivisionOpContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleArithmeticVisitor ) return ((SimpleArithmeticVisitor<? extends T>)visitor).visitDivisionOp(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class FactorialOpContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleArithmeticVisitor ) return ((SimpleArithmeticVisitor<? extends T>)visitor).visitFactorialOp(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class SignedValueContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleArithmeticVisitor ) return ((SimpleArithmeticVisitor<? extends T>)visitor).visitSignedValue(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class AdditionOpContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleArithmeticVisitor ) return ((SimpleArithmeticVisitor<? extends T>)visitor).visitAdditionOp(this);
			else return visitor.visitChildren(this);
		}
	}
