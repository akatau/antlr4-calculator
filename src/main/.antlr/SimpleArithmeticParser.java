// Generated from /mnt/sda4/Projects/Compilers Course/antrlCalculator/src/main/SimpleArithmetic.g4 by ANTLR 4.13.1
...
public class SimpleArithmeticParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ExponentationOpContext extends ExpressionContext {
		public List<ExpressionContext> expression() {
			return getRuleContexts(ExpressionContext.class);
		}
		public ExpressionContext expression(int i) {
		...
		public ExponentationOpContext(ExpressionContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						_localctx = new ExponentationOpContext(new ExpressionContext(_parentctx, _parentState));
